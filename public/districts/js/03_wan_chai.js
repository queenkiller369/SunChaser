...
var info_config = [];
  ...
  async function loadGoogleMapMarkersInfo(){
    ...
    for (let databaseMapMarker of databaseMapMarkers){
      info_config.push(`<div style="font-size:130%; font-weight:800; font-family: 'Noto Sans HK', sans-serif;"><b>${databaseMapMarker.title}</b></div><br/> 
...
function initMap() {
  ...
  map.data.setStyle(function(feature){
    if(feature.getProperty("District")=="Wan Chai"){
      return {
        fillColor: 'green',
        fillOpacity: 0.1,
        strokeWeight: 1,
